...
- **Modern Architecture**: Built on Next.js App Router for optimal performance, SSR, and SEO.
- **Dynamic Content Management**: Component data (Skills, Projects, Bio) is modularized in `assets/data/` for easy maintainability.
...
- **Deployment**: Vercel
- **Assets**: Organized component-based asset imports
...
my-portfolio/
├── app/
│   ├── components/      # Reusable UI sections (Header, AboutMe, Projects, etc.)
│   ├── globals.css      # Tailwind & base styles
│   ├── layout.js        # Root layout wrapper
│   └── page.js          # Main landing page
├── assets/
│   ├── background/      # UI patterns and background textures
│   ├── data/            # JSON/JS structured data (projects.js, skills.js, etc.)
│   ├── profile/         # Personal branding images
│   ├── projects/        # High-res project screenshots
│   ├── tech/            # Technology and language logos
│   └── ui/              # Functional interface icons
├── public/
│   └── resume/          # Downloadable PDF assets
