import { projectData, techLogos } from "@/assets/ProjectSkillIcon/Projectskillicon";
  ...
  return (
    <div id="projects" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12">
        Welcome to my Project Section! Explore a collection of projects showcasing my expertise in AI,ML and Backend technologies.
      </p>
